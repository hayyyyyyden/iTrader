...
class SPYDailyForecastStrategy(Strategy):
    """
    S&P500 forecast strategy. It uses a Quadratic Discriminant Analyser to
    predict the returns for a subsequent time period and then generated
...
if __name__ == "__main__":
    ...
    backtest = Backtest(
        ...
        NaivePortfolio, SPYDailyForecastStrategy
    )
